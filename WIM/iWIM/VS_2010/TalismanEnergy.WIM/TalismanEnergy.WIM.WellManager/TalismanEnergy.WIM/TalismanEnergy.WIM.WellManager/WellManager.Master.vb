...
Partial Public Class WellManager
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    LabelApp.Text = appName + " " + appVersion + " @ " + dbName + "<br />" + Request.ServerVariables("AUTH_USER")
    ' LabelCopyright.Text = ConfigurationManager.AppSettings("COPYRIGHT") + "<br />" + Session.SessionID
