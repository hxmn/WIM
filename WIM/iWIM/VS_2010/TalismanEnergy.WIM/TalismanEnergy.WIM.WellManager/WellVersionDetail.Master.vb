...
#End Region
  ...
  Private Sub LoadBAListItems(ByVal ddl As ComboBox, _
    ...
    If filterInDB Then
      If sFilter.Length > 0 Then
                sFilter = "UPPER(BA_NAME) LIKE '" + sFilter.ToUpper().Replace("'", "''") + "%'"
      End If
...
#Region "Basin"
  ...
  Private Sub LoadBasinItems(ByVal iStartIndex As Integer, ByVal iNumItems As Integer, ByVal sFilter As String)
    ...
    Try
      ...
      'Dim strFilterCountry = "COUNTRY = '" + ddlCountry.SelectedValue + "' AND "
      ...
      '    sFilter = sFilter.Replace("'", "''")
      '  End If
      '  BasinLookUpList.DefaultView.RowFilter = strFilterCountry + "BASIN_NAME LIKE '" + sFilter + "%'"
      'Else
      '  BasinLookUpList.DefaultView.RowFilter = strFilterCountry + "BASIN_NAME LIKE '%'"
      'End If
...
#Region "Location Grid"
  ...
  Private Sub UpdateLocationGrid(ByVal item As ComponentArt.Web.UI.GridItem, ByVal Action As String)
    ...
    params("REMARK") = IIf(String.IsNullOrEmpty(item("REMARK")), System.DBNull.Value, item("REMARK"))
    params("LOCATION_ACCURACY") = IIf(String.IsNullOrEmpty(item("LOCATION_ACCURACY")), System.DBNull.Value, item("LOCATION_ACCURACY"))
