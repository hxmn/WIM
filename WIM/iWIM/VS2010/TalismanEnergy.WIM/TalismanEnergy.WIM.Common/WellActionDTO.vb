...
Public Class WellActionDTO
  ...
  Public ReadOnly Property ROW_CHANGED_DATE() As Date
    Get
      If WELL_VERSION.Rows(0)("ROW_CHANGED_DATE") Is System.DBNull.Value Then Return Nothing
      Return WELL_VERSION.Rows(0)("ROW_CHANGED_DATE")
    End Get
  End Property

  Public ReadOnly Property ROW_CHANGED_BY() As String
    Get
      If WELL_VERSION.Rows(0)("ROW_CHANGED_BY") Is System.DBNull.Value Then Return ""
      Return WELL_VERSION.Rows(0)("ROW_CHANGED_BY").ToString()
    End Get
  End Property
