...
Public Class Global_asax
    ...
    Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
        ...
        LogEvent(String.Format("iWIM version 1.0 started on {0}.", Now), EventLogEntryType.Information)
    End Sub
    ...
    Sub Application_End(ByVal sender As Object, ByVal e As EventArgs)
        ...
        LogEvent(String.Format("iWIM version 1.0 ended on {0}.", Now), EventLogEntryType.Information)
    End Sub
    ...
    Function GetErrorMessage() As String
        ...
        'create the error message 
        Dim sMessage As String = lastException.Message & _
                                    vbCrLf & vbCrLf & _
