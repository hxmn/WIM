...
Partial Public Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Not String.IsNullOrEmpty(Request.Params("HiddenTLMIdsForWIM")) Then
                buildGrid(Request.Params("HiddenTLMIdsForWIM").ToString)
                Session("SearchedWells") = Request.Params("HiddenTLMIdsForWIM")
    ...
    Private Sub buildGrid(ByVal tlmIds As String)
        ...
        Try
            ...
            dtWell = gw.FindWells(tlmIds, "Well")
            ...
            If Not sWellList = String.Empty Then
                ...
                dtVersion = gw.FindVersions(sWellList, "Version")
    ...
    Private Sub InactivateVersion(ByVal tlmId As String, ByVal source As String)
        ...
        Try
            ...
            If wa.STATUS_CD = WELL_ACTION_COMPLETE Then
                lblMessage2.Text = "Inactivate Version - TLM ID [" & tlmId & "] Source [" & source & "] - SUCCESSFUL!"
                lblMessage2.ForeColor = Drawing.Color.Black
            Else
                lblMessage2.Text = "Inactivate Version - TLM ID [" & tlmId & "] Source [" & source & "] - FAILED! "
    ...
    Private Sub DeleteVersion(ByVal tlmId As String, ByVal source As String)
        ...
        Try
            ...
            If wa.STATUS_CD = WELL_ACTION_COMPLETE Then
                lblMessage2.Text = "Delete Version - TLM ID [" & tlmId & "] Source [" & source & "] - SUCCESSFUL!"
                lblMessage2.ForeColor = Drawing.Color.Black
            Else
                lblMessage2.Text = "Delete Version - TLM ID [" & tlmId & "] Source [" & source & "] - FAILED! "
                lblMessage2.Text += wa.ERRORMSG.Split(";")(0).Split(",")(1)
                lblMessage2.ForeColor = Drawing.Color.DarkRed
            End If
