...
#Region "Source"
    ...
    Private Sub LoadSourceItems(ByVal iStartIndex As Integer, ByVal iNumItems As Integer, ByVal sFilter As String)
        ...
        Dim SourceLookUpList As DataTable = CType(Session("UserPermissions"), DataSet).Tables(USER_CREATE_PERMISSION)
...
#Region "Private Functions"
    ...
    Private Sub InitializeLookUpListControls()
        ...
        Dim dbconnection As String = ConfigurationManager.ConnectionStrings("WIMDBORAConnection").ToString()
        Dim gw As New GatewayAccess(dbconnection)
        Dim wa As New WellActionDTO(gw.GetVersion("", ""))
    ...
    Private Function PopulateWellActionDTO() As WellActionDTO
        ...
        wa.COUNTRY = GetDropDownListSelectedValue(ddlCountry)
        ...
        If Not String.IsNullOrEmpty(wa.SOURCE) Or _
           Not String.IsNullOrEmpty(wa.IPL_UWI_LOCAL) Or _
           Not String.IsNullOrEmpty(wa.COUNTRY) Or _
           Not String.IsNullOrEmpty(wa.WELL_NAME) Then
    ...
    Private Function GetDropDownListSelectedValue(ByRef ddl As ComboBox) As String
    ...
    Private Sub HandleErrors(ByRef wa As WellActionDTO)
        ...
        lblCreateWell.Text = "Create Well - FAILED!"
        lblCreateWell.ForeColor = Drawing.Color.DarkRed
