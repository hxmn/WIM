...
Partial Public Class EditWell
    ...
    Protected Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            Else
                ...
                Session("WellActionDTO") = New WellActionDTO(gw.GetVersion(wa.UWI, wa.SOURCE))
    ...
    Private Sub SetControlValues(ByVal TLMId As String, ByVal Source As String)
        ...
        lblSource2val.Text = ddlSource.Text
        ...
        If Not wa.PROFILE_TYPE = VERTICAL Then
...
#Region "Source"
    ...
    Private Sub LoadSourceItems(ByVal iStartIndex As Integer, ByVal iNumItems As Integer, ByVal sFilter As String)
        ...
        Dim SourceLookUpList As DataTable = CType(Session("UserPermissions"), DataSet).Tables(USER_UPDATE_PERMISSION)
...
#Region "Private Functions"
    ...
    Private Function GetwaUpdates(ByRef wa As WellActionDTO) As WellActionDTO
    ...
    Private Sub CheckForUpdates(ByRef wa As WellActionDTO)
        ...
        If Not wa.IPL_LICENSEE = GetDropDownListSelectedValue(ddlLicensee, wa.IPL_LICENSEE, wa.IPL_LICENSEE_NAME) Then wa.IsWellVersionChanged = True
        ...
        If Not wa.IPL_BASIN = GetTextBoxText(txtBasin) Then wa.IsWellVersionChanged = True
    ...
    Private Sub HandleErrors(ByRef wa As WellActionDTO)
        ...
        lblEditVersion.Text = "Edit Version - TLM ID [" & wa.UWI & "] Source [" & wa.SOURCE & "] - FAILED!"
        lblEditVersion.ForeColor = Drawing.Color.DarkRed
        ...
        If blnHasUnhandledErrors Then
            ...
            sErrorText = "Please review & resubmit updates made to this version, as the following failure occurred:" & "\n\n"
