<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/WellManager.Master" CodeBehind="WellVersion.aspx.vb" Inherits="TalismanEnergy.WIM.iWIM.WellVersion" 
    title="" %>
...
<asp:Content ID="Content1" 
    ...
    <asp:Label ID="lblMndtry" 
        ...
        Style="left: 825px; position: absolute; top: 52px; z-index: 102;" 
        Width="148px" 
        Font-Names="Verdana" 
        Font-Size="X-Small" 
        Font-Bold="False" 
            ...
            <ComponentArt:PageView ID="PageView1"
                ...
                <asp:Panel ID="pnlIdentityGroup" 
                    ...
                    <asp:Panel ID="pnlCountry"
                        ...
                        <%--<ComponentArt:ComboBox ID="ddlCountry" 
                            ...
                            Width="310">
                            <ClientEvents>
                                <Change EventHandler="countryChange"/>
                            </ClientEvents>
                        </ComponentArt:ComboBox>--%>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="pnlOnOffShoreInd"
                        runat="server" >
                        <asp:TextBox ID="txtddlOnOffShoreInd" 
                            ReadOnly="true"
                    ...
                    <asp:Panel ID="pnlWellProfileType"
                        runat="server" >
                        <asp:TextBox ID="txtddlWellProfileType" 
                            ReadOnly="true"
                            CssClass="inputtxtControl" 
                    ...
                    <asp:Panel ID="pnlCurrentStatus"
                        runat="server" >
                        <asp:TextBox ID="txtddlCurrentStatus" 
                            ReadOnly="true"
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlElevationGroup" 
                    ...
                    <asp:Panel ID="pnlGroundElevUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlGroundElevUnits" 
                            ReadOnly="true"
                            CssClass="inputtxtControl" 
                    ...
                    <asp:Panel ID="pnlDerrickFloorUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlDerrickFloorUnits" 
                            CssClass="inputtxtControl" 
                            ReadOnly="true"
                    ...
                    <asp:Panel ID="pnlKBElevUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlKBElevUnits" 
                            ReadOnly="true"
                            CssClass="inputtxtControl" 
                    ...
                    <asp:Panel ID="pnlRotaryTableElevUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlRotaryTableElevUnits" 
                            CssClass="inputtxtControl" 
                            ReadOnly="true"
                    ...
                    <asp:Panel ID="pnlWaterDepthUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlWaterDepthUnits" 
                            CssClass="inputtxtControl" 
                            ReadOnly="true"
                    ...
                    <asp:Panel ID="pnlCasingFlangeUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlCasingFlangeUnits" 
                            CssClass="inputtxtControl" 
                    ...
                    <asp:Panel ID="pnlTotalDepthUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlTotalDepthUnits" 
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlBasin" 
                    ...
                    <asp:Panel ID="pnlProvState"
                        runat="server" >
                        <asp:TextBox ID="txtddlProvState" 
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlLocation" 
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <input type="button" disabled onclick="NewLocationRow();" value="Add Location" id="btnAddLocation" runat="server"/> </td>
                      </tr>
                    </table>
                           ...
                           <ComponentArt:GridLevel
                                ...
                                <Columns>
                                    ...
                                    <ComponentArt:GridColumn DataField="LONGITUDE" 
                                                             ...
                                                             Width="140"
                                                             FixedWidth="true"/>
                                    <ComponentArt:GridColumn DataField="COORD_SYSTEM_NAME" 
...
//    var unit = ddlPlugbackTVDUnits.get_text();
    if (elev != null)
    {
        if (elev.value.length > 0)
        {
            ...
            <ComponentArt:PageView ID="PageView2"
                ...
                <asp:Panel ID="pnlOSA" 
                    ...
                    <asp:Panel ID="pnlOldestStratAge"
                        runat="server" >
                        <asp:TextBox ID="txtddlOldestStratAge" 
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlTDSA"
                    ...
                    <asp:Panel ID="pnlTDStratAge"
                        runat="server" >
                        <asp:TextBox ID="txtddlTDStratAge" 
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlPlugbackDepth" 
                    ...
                    <asp:Panel ID="pnlPlugbackDepthUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlPlugbackDepthUnits" 
                            CssClass="inputtxtControl" 
                ...
                <asp:Panel ID="pnlPlugbackTVD" 
                    ...
                    <asp:Panel ID="pnlPlugbackTVDUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlPlugbackTVDUnits" 
                            CssClass="inputtxtControl" 
                            Style="left: 332px; top: 6px; position: absolute; z-index: 103;" 
                            TabIndex="45"  
                            Width="98px"
                ...
                <asp:Panel ID="pnlMaxTVD" 
                    ...
                    <asp:Panel ID="pnlMaxTVDUnits"
                        runat="server" >
                        <asp:TextBox ID="txtddlMaxTVDUnits" 
                            CssClass="inputtxtControl" 
                            Style="left: 332px; top: 6px; position: absolute; z-index: 103;" 
                            TabIndex="47"  
                            Width="98px"
