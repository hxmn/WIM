create or replace PACKAGE BODY     WIM_Rollup
IS
/*-----------------------------------------------------------------------------------------------------------------------------------
 SCRIPT: WIM.WIM_Rollup.pkb
...
HISTORY:
 ========== ===============================================================
 2008.03.06     Doug Henderson, Talisman Energy Ltd.    initial creation from old version of well_refresh
 2008.03.07     Doug Henderson, Talisman Energy Ltd.    refactor and reformat
 2008.03.11     Doug Henderson, Talisman Energy Ltd.    refactor to make null_row procedure
 2008.05.06     Doug Henderson, Talisman Energy Ltd.    adjust priority of nodes based on sources and datums
 2008.05.13     Doug Henderson, Talisman Energy Ltd.    revise node priority. I.E., move 150TLMX above 200TLI
                                                        overwrite well (bottom_hole|surface)_(lat|long)itude with values from well_node
 2008.06.05     Doug Henderson, Talisman Energy Ltd.    inactivate the well row when there are no well_version rows
                                                        inactivate the well_node row when there are no well_node_version rows
 2008.06.18     Doug Henderson, Talisman Energy Inc.    refactor as package
 2008.06.27     Doug Henderson, Talisman Energy Ltd.    add NAD83 to geog2epsg function
 2008.07.23     Doug Henderson, Talisman Energy Inc.    add 850TLML source
 ...
 2008.07.24     Doug Henderson, Talisman Energy Inc.    validate well versions
                                                        mark orphan well_alias rows as inactive
 2008.09.05     Doug Henderson, Talisman Energy Inc.    expose geog2epsg function.
 2008.10.22     Doug Henderson, Talisman Energy Inc.    change dependency chaining in ready().
                                                        only update well surface/base node ids when they would change.
 2008.10.23     Doug Henderson, Talisman Energy Inc.    add new source 590TLMR
 2008.11.05     Doug Henderson, Talisman Energy Inc.    modify well_node columns to more closely match PPDM 3.7 standard
                                                         rename primary_source to source, ...
 2009.01.07     Doug Henderson, Talisman Energy Inc.    remove AUTHID CURRENT_USER clause
 2009.01.09     Doug Henderson, Talisman Energy Inc.    handle case when only override version remains
 2009.03.06     Doug Henderson, Talisman Energy Inc.    lookup and calculate node ids in well_and_nodes
                                                        do not call well/node validator - too many messages
 2009.03.23     Doug Henderson, Talisman Energy Inc.    use NOCOPY for large record parameters
 2009.06.16     Doug Henderson, Talisman Energy Inc.    correct logic error when inactivating an isolated 075TLMO well version
 ...
 2009.12.21     Floy Baird, TLM                         Remove 590TLMR - this source deemed obsolete by Well Data Steward
 ...
 2010.03.19     Floy Baird, TLM                         Add function on row_updated to move the most recent date into composite well to ensure 
                                                        user knows some attribute has been changed on that date
 2010.03.29     Floy Baird, TLM                         Add Function to Get Active_Ind flag to determine whether the rollup will act only 
                                                        on 'ACTIVE'('Y') or INACTIVE'('N') Versions
 2010.04.19     Floy Baird, TLM                         Add Changed_by and Changed_Date logic to roll up the most recent date and to pair that with changed_by 
                                                        to indicate to consumers of the data the most recent currency of change and by who
 2010.07.30     Richard Masterman, TLM   Added MAX to the Last_Chg_by function in case 2 records have the same timestamp
 2010.08.23     Richard Masterman
                                     ...
                                     9) Same approach to create date/update date applied to WELL rollup for consistency and speed
 ...
 2010.10.22     Richard Masterman    Changed WARNING for removing last composite well or node to an INFO message as it is a regular
                                        and acceptable update.
 2010.11.04     Richard Masterman        Changed the roll ups to NOT retain composite wells/nodes if no ACTIVE versions exist and not
                                         to report an INFO message if there was no composite WELL or WELL_NODE to clean up
 2011.01.17     Richard Masterman        Source roll up now COMMITs changes every 1000 wells and logs progress to avoid locking the whole 
                                         dataset or blowing resource limits
 2011.05.26     Virinder Rajpoot        Added new Sources for GeoChem wells.(662GCG,660GCW,664GCF) 
 2011.11.03     Virinder Rajpoot        Removed Desc order from cursor in Node_Rollup procedure, so NAD27 takes precedence over NAD83
 2011-11-21     Virinder Rajpoot        Added new Sources fro UK and Norwegian wells ( 310UKD, 320NPD)
 2011-12-13     Virinder Rajpoot        Added new source 090DSS for GeoWiz updates. 
 2011-12-21     Virinder Rajpoot        Updated Update_WV_Location procedure: Removed DESC from where clause.
 2012-01-19     Virinder Rajpoot        Changed Source_Rollup to call Well_Rollup instead of Well_Version_Rollup
 2012-10-26     Virinder Rajpoot        Added new source 350REG 
 2012-11-20     Virinder Rajpoot        changed precedence order for Node Rollup. Moved 100TLM after 500PRB. Task #1173
 2012-11-28     Virinder Rajpoot        Modifed Update_WV_Location procedure to filter out nodes with Null Lat/Longs
 2013-01-09     Virinder Rajpoot        1) Modified node_rollup procedure. to rollup Latitude and Longitude together as a group.
                                        2) Added new source in source rollup order (725TLI, 750FNDR and 900TLMU)
                                        ver: 2.0.2
                                        
 2013-02-14     Virinder Rajpoot        1) Modified well_rollup prcedure to rollup  Current_Status and Status_Data as a group
                                        2) Removed 200TLI and 400FNDR sources from well_version_rollup and node_rollup
                                        ver: 2.0.3
                                                                                
 2013-05-01     Virinder Rajpoot        Removed Function geog2epsg. Dont need to convert coord_system_id to epsg codes. It is already being stored in
                                        epsg format.
                                        ver: 2.0.4
                                        
 2013-07-29      Virinder Rajpoot        Added new two attributes Surface_Location_Accuracy and Bottom_Hole_Location_Accuracy
                                        to the Well roll up
                                        Added one attribute Location_Accuract to well_Node roll up
                                        Modified Update_WV_Location procedure to include location_accuracy  
                                        ver: 2.0.5
2014.05.14      Kevin Edwards           Changed current_status and status_type to be rolled up together
                                        ver 2.0.6
2015.04.11      Kevin Edwards           Removed hardcoded source list in favour of the new r_rollup table fore well_node_rollup and version_rollup
                                        ver 2.0.7                                        
----------------------------------------------------------------------------------------------------------*/
...
------------------------------------------------------------------------------------------------------------*/
 ...
 /*----------------------------------------------------------------------------------------------------------
Procedure:  MERGE_WELL
Detail:    LOCAL PROCEDURE - Inserts or updates the new rolled up well record
            
Called By:  Well_Version_Rollup
Calls:      
...
------------------------------------------------------------------------------------------------------------*/
 ...
 BEGIN
     ...
     a_row.surface_location_accuracy surface_location_accuracy,
     a_row.bottom_hole_location_accuracy bottom_hole_location_accuracy
     FROM DUAL) src
     ON (dst.uwi = src.uwi)
     WHEN MATCHED THEN
     UPDATE
     ...
     surface_location_accuracy = src.surface_location_accuracy,
     bottom_hole_location_accuracy = src.bottom_hole_location_accuracy
     ...
     src.ipl_uwi_local, src.row_quality, src.surface_location_accuracy, src.bottom_hole_location_accuracy);
     EXCEPTION
     WHEN OTHERS
     THEN
     tlm_process_logger.sqlerror
     ('WIM.WIM_Rollup.Merge_Well: Exception during roll up of well '
     || a_row.uwi || '(' || a_row.source || ')');
     RAISE;
 END merge_well;

 /*----------------------------------------------------------------------------------------------------------
Procedure:  NULL_WELL_ROW
Detail:    LOCAL PROCEDURE - Sets the new composite well record to NULL ready to roll up into
...
Created On: June. 2008
History of Change:
July 29, 2013   V.Rajpoot   Added new atribute Location_Accuracy
...
------------------------------------------------------------------------------------------------------------*/
 ...
 IS
  ...
  BEGIN
     ...
     a_row.surface_location_accuracy    := NULL;
     a_row.bottom_hole_location_accuracy            := NULL;
 END null_well_row;
 
 
 /*----------------------------------------------------------------------------------------------------------
Procedure:  UPDATE_WV_LOCATION
Detail:    LOCAL PROCEDURE to update the WELL_VERSION table with the highest precedence location for the specified source 
            
Called By:  Node_Rollup
Calls:      

Created On: June. 2008
History of Change:
2012-11-28  Virinder Rajpoot        Modified to filter out Null Lat/Longs
2013-08-08  Virinder Rajpoot        Mpdofied to include Location Accuracy
------------------------------------------------------------------------------------------------------------*/
 PROCEDURE Update_WV_Location (pTLM_ID IN VARCHAR2,
 pSource     IN VARCHAR2,
 pPosition   IN VARCHAR2) IS

 cNode_ID       well_node_version.Node_ID%TYPE;
 cLatitude      well_node_version.Latitude%TYPE;
 cLongitude     well_node_version.Longitude%TYPE;
 cLocAccuracy   well_node_version.location_accuracy%TYPE;


 -- Returns active nodes in precedence order given the well, source and position 
 CURSOR Node_Version
 IS
 SELECT Node_ID, Latitude, Longitude, location_accuracy
 ...
 FETCH Node_version INTO cNode_ID, cLatitude, cLongitude,cLocAccuracy;
...
--        
 ...
 -- Update the values into the WELL_VERSION table
     ...
     THEN
         ...
         bottom_hole_location_accuracy = cLocAccuracy
         WHERE uwi = pTLM_ID
         AND Source = pSource;
     ELSIF pPosition = 'S'
     THEN
         ...
         surface_location_accuracy = cLocAccuracy
         WHERE uwi = pTLM_ID
         AND Source = pSource;
...
/*----------------------------------------------------------------------------------------------------------
Procedure:  Null_Node_Row
Detail:    LOCAL PROCEDURE - Sets the new composite node record to NULL ready to roll up into
...
------------------------------------------------------------------------------------------------------------*/
 ...
 BEGIN
     ...
     a_row.ipl_uwi              := NULL;
     a_row.row_quality          := NULL;
     a_row.location_accuracy    := NULL;
 
 END null_node_row;

/*----------------------------------------------------------------------------------------------------------
Procedure:  Merge_Node
Detail:    LOCAL PROCEDURE - Inserts or updates the new rolled up well Node record
...
------------------------------------------------------------------------------------------------------------*/
 ...
 --l_coord_system_id := geog2epsg (a_row.geog_coord_system_id);
     ...
     a_row.row_quality row_quality,
     a_row.geog_coord_system_id coord_system_id,
     a_row.location_accuracy location_accuracy
     FROM DUAL) src
     ...
     location_accuracy = src.location_accuracy
     ...
     INSERT (node_id, SOURCE, node_obs_no, acquisition_id,
             ...
             coord_system_id, location_accuracy)
        VALUES (src.node_id, src.SOURCE, src.node_obs_no,
                ...
                src.coord_system_id, src.location_accuracy);
        EXCEPTION
            WHEN OTHERS
            THEN
                tlm_process_logger.sqlerror ('WIM_Rollup.Merge_node: Exception during roll up of node '
...
/*----------------------------------------------------------------------------------------------------------
Procedure:  WELL_VERSION_ROLLUP
Detail:     Local PROCEDURE 
            Build a well row that accumulates all information from WELL_VERSION rows.
...
Called By:  Well_Rollup
Calls:      

Created On: June. 2008
History of Change:
2013-01-21     Virinder Rajpoot       Added 725TLI, 750FNDR and 900TLMU sources to the sort order list.
2013-07-29     Virinder Rajpoot       Added new atribute Location_Accuracy to Update and Inserts
2014.05.14      Kevin Edwards       Changed current_status and status_type to be rolled up together
------------------------------------------------------------------------------------------------------------*/
...
IS
       ...
       cursor well_list
          is
              ...
              join wim.r_rollup r on wv.source = r.source and wv.active_ind = r.active_ind
              where wv.uwi = input_uwi
                  and wv.active_ind = 'Y'
              order by wv.uwi, r.well_version_order
              ;
    BEGIN
        select char_length into remark_size
        from all_tab_columns
        where table_name = 'WELL' and column_name = 'REMARK';
        ...
        FOR old_row IN Well_list LOOP
            ...
            -- 1333 - WIM Roll Up - group status and status type
            IF (new_row.current_status IS NULL AND old_row.current_status IS NOT NULL)
               AND
               (new_row.status_type IS NULL AND old_row.status_type IS NOT NULL)
            THEN
...
--            END IF;
             ...
             -- 1730 - WIM Roll Up - group parent_uwi and ipl_uwi_local
            IF (new_row.parent_uwi IS NULL AND old_row.parent_uwi IS NOT NULL)
               AND
               (new_row.status_type IS NULL AND old_row.status_type IS NOT NULL)
            THEN
            ...
            -- 1106 - WIM Rollup - Composite Remark a merger of all versions
            if new_row.remark is null and old_row.remark is not null then
                new_row.remark := substr('(' || old_row.source || ') ' || old_row.remark, 0, remark_size - 1);
            elsif old_row.remark is null then
                null;
            elsif (length(nvl(new_row.remark, '''')) + length(nvl(old_row.remark, '''')) + length(old_row.source) + 5) < remark_size - 1 then
                new_row.remark := substr(new_row.remark || ' - (' || old_row.source || ') ' ||  old_row.remark, 0, remark_size - 1);
            end if;
...
--            END IF;
            ...
            IF new_row.surface_location_accuracy IS NULL AND old_row.surface_location_accuracy IS NOT NULL
            THEN
                new_row.surface_location_accuracy := old_row.surface_location_accuracy;
            END IF;
            
              IF new_row.bottom_hole_location_accuracy IS NULL AND old_row.bottom_hole_location_accuracy IS NOT NULL
            THEN
                new_row.bottom_hole_location_accuracy := old_row.bottom_hole_location_accuracy;
            END IF;
       ...
       ELSE
           ...
           IF Row_Count != 0 THEN
             ...
             TLM_Process_Logger.INFO ('The Well ' || Input_UWI || ' has no active versions left. Composite well removed.');
    ...
    EXCEPTION
        WHEN OTHERS
        THEN
            tlm_process_logger.sqlerror ('WIM_Rollup.Well_Version_Rollup: Exception during roll up of well '
                                          || new_row.uwi || '(' || new_row.source || ')');
            RAISE;
    END Well_Version_Rollup;

/*----------------------------------------------------------------------------------------------------------
Procedure:  NODE_ROLLUP
Detail:     Local PROCEDURE 
...
Created On: June. 2008
History of Change:
2013-01-21     Virinder Rajpoot        Modified node_rollup procedure. to rollup Geog_Coord_system_ID, Location_Qualifier,
                                        Latitude and Longitude together as a group.
                                        Added 725TLI, 750FNDR and 900TLMU sources to the sort order list.
2013-07-29     Virinder Rajpoot       Added new atribute Location_Accuracy to Update and Inserts
...
------------------------------------------------------------------------------------------------------------*/
    ...
    IS
        ...
        is
            ...
            join wim.r_rollup r on wnv.source = r.source and wnv.active_ind = r.active_ind
            where wnv.node_id = input_node_id
                and wnv.node_position = input_node_position
                and wnv.active_ind = 'Y'
            order by wnv.node_id
                , r.well_node_order
                , wnv.geog_coord_system_id -- IHS27, IHS83, NAD27, NAD83, WGS84, ...
                , wnv.node_obs_no desc
    ...
    BEGIN
        ...
        LOOP
           ...
           --Roll up Latitude/Longitude/location_accuracy together
           IF ((new_row.latitude IS NULL OR new_row.longitude IS NULL ) 
                AND (old_row.latitude IS NOT NULL AND old_row.longitude IS NOT NULL)) OR
                ((new_row.latitude IS NULL AND new_row.longitude IS NULL ) 
                AND (old_row.latitude IS NOT NULL OR old_row.longitude IS NOT NULL))
            THEN
                new_row.latitude := old_row.latitude;
                new_row.longitude := old_row.longitude;
                new_row.geog_coord_system_id := old_row.geog_coord_system_id;
                new_row.location_accuracy := old_row.location_accuracy;
                new_row.location_qualifier := old_row.location_qualifier;            
            END IF;
        ...
        ELSE
           ...
           IF Row_Count != 0 THEN
             ...
             TLM_Process_Logger.INFO ('The Node ' || Input_Node_ID || ' has no active versions left. Composite node removed.');
           END IF;
           ...
           THEN
                ...
                UPDATE well
                   SET bottom_hole_latitude = new_row.latitude,
                       ...
                       bottom_hole_location_accuracy = new_row.location_accuracy
              ...
              THEN
                ...
                UPDATE well
                   SET surface_latitude = new_row.latitude,
                       ...
                       surface_location_accuracy = new_row.location_accuracy
                 WHERE uwi = Input_TLM_ID;
         END IF;
    ...
    EXCEPTION
        WHEN OTHERS
        THEN
            tlm_process_logger.sqlerror ('WIM_Rollup.Node_Rollup: Exception during roll up of node '
                                               || new_row.node_id || '(' || new_row.source || ')');
            RAISE;
    END Node_Rollup;

/*----------------------------------------------------------------------------------------------------------
Procedure:  Source_Rollup
Detail:     PROCEDURE 
            Procedure to rollup all multiple well version rows for the
...
------------------------------------------------------------------------------------------------------------*/
    ...
    BEGIN
        ...
        tlm_process_logger.info ('WIM_Rollup.Source_Rollup: Start Rollup for '
        ...
        COMMIT;
        tlm_process_logger.info ('WIM_Rollup.Source_Rollup: Rollup Complete. Rolled up '
                                      || TO_CHAR (Rolled_Up_Wells) || ' "' || input_source || '" wells.'
                                     );
    END Source_Rollup;
    
/*----------------------------------------------------------------------------------------------------------
Procedure:  Well_Rollup
Detail:     Procedure to rollup multiple well versions for a single well into
            a single well row. 
            Rollup a WELL, including the WELL_NODE rows for the specified well.
            Find the well nodes by using the node_id convention - ensures new nodes
            are included

Called By:  Source_Rollup
Calls:      Well_Version_Rollup
            Node_Rollup
...
------------------------------------------------------------------------------------------------------------*/
    ...
    BEGIN
        ...
        Node_Rollup (Input_UWI, Input_UWI || '1', 'S');

       -- Rollup the Base Location
        Node_Rollup (Input_UWI, Input_UWI || '0', 'B');
