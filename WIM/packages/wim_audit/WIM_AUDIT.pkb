...
Detail:     Gets an audit ID to allow audit entries to be grouped for a specific
...
Detail:     Adds an entry to the Audit log.
...
Detail:     This procedure deletes from wim_audit_log table.
