...
from well_version
where uwi in (select uwi from well_version where source ='300IPL'
minus
select uwi from test36.well_version where source='300IPL');
...
where rundate > to_date ('16-DEC-2009', 'DD-MON-YYYY')
union
select base_node_id from TEMP_WV_300IPL_DELETED
where rundate > to_date ('16-DEC-2009', 'DD-MON-YYYY'));

select count(1) from TEMP_WV_300IPL_DELETED where rundate > to_date ('16-DEC-2009', 'DD-MON-YYYY');
