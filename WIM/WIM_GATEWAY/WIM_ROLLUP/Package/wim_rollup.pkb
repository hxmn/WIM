...
2014.05.14      Kevin Edwards           Changed current_status and status_type to be rolled up together
                                        ver 2.0.6
2014.05.14      Kevin Edwards           well_version_rollup and node_rollup now use the WIM_R_ROLLUP table to get rollup ordering
										Added test procedure to add/update/delete rollup sources 
