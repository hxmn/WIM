...
/*----------------------------------------------------------------------------------------------------------
 ...
 PURPOSE:
   Package body for the WIM WIM_LOADER functionality, to load 500PRB source wells to PPDM
   using WIM GATEWAY
    ...
    WELL_ACTION             This procedure reads WIM_STG_REQUEST rows with status = 'R'and calls WIM_GATEWAY.WELL_ACTION
                            to process.  This is called from LOAD_PROBE_WELLS, INACTIVATE
                            REACTIVATE, INACTIVATE_500_SOURCE AND PROCEDURES
    ...
    INACTIVATE              This procedure Inactivates wells in PPDM database.
                            This is called from Load_Probe_Wells.                 
 ...
 *****************************************************************************
    ...
    to process. 
    This is called from LOAD_PROBE_WELLS, INACTIVATE, REACTIVATE, INACTIVATE_500_SOURCE PROCEDURES
...
*/ 
  ...
  /*-------------------------------------------------------------------------------
  Proocedure: REFRESH_PROBE_TABLES
  Purpose:    To refresh PROBE(IHS INT) Tables
