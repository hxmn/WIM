...
drop view ppdm.ihs_well_test_analysis;

create or replace force view ppdm.ihs_well_test_analysis
(
  uwi,
  source,
  test_type,
...
grant select on ppdm.ihs_well_test_analysis to ppdm_ro;
