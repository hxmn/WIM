/***************************************************************************************************
 ihs_cdn_well_test_mud  (view)

 20150817 copied from ihs_well_test_mud, adapted code by vrajpoot  (task 1164)
...
as
  select /*+ use_nl(wtmud wv) */
    ...
    from well_test_mud@c_talisman_ihsdata wtmud, ppdm.well_version wv
