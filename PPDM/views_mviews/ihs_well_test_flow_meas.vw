...
drop view ppdm.ihs_well_test_flow_meas;

create or replace force view ppdm.ihs_well_test_flow_meas
(
  uwi,
  source,
  test_type,
...
as
  select /*+ use_nl(wtfm wv) */
         ...
         wtfm.row_quality,
         wtfm.province_state
    from well_test_flow_meas@c_talisman_ihsdata wtfm, well_version wv
...
grant select on ppdm.ihs_well_test_flow_meas to ppdm_ro;
