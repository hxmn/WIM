...
drop view ppdm.ihs_well_test_flow;

create or replace force view ppdm.ihs_well_test_flow
(
  uwi,
  source,
  test_type,
...
grant select on ppdm.ihs_well_test_flow to ppdm_ro;
