/***************************************************************************************************
 ihs_cdn_strat_well_section  (view)

 20150817 copied from ihs_strat_well_section, adapted code by vrajpoot  (task 1164)

 **************************************************************************************************/

--drop view ppdm.ihs_cdn_strat_well_section;


create or replace force view ppdm.ihs_cdn_strat_well_section
(
   uwi,
   strat_name_set_id,
   strat_unit_id,
