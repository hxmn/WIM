/***************************************************************************************************
 ihs_us_well_test_mud  (view)

 20150812   cdong       Task 1164 add IHS-US data to combo views, adapted code by vrajpoot

 **************************************************************************************************/

--drop view ppdm.ihs_us_well_test_mud;


create or replace force view ppdm.ihs_us_well_test_mud
(
  uwi,
  source,
  test_type,
...
as
  select /*+ use_nl(wtmud wv) */
    ...
    from well_test_mud@c_talisman_us_ihsdataq wtmud, ppdm.well_version wv
    where    wv.well_num = wtmud.uwi
         and wv.source = '450PID'
         and wv.active_ind = 'Y'
;


grant select on ppdm.ihs_us_well_test_mud to ppdm_ro;
