/***************************************************************************************************
 ihs_cdn_well_core_sample_anal  (view)

 20150813 copied from ihs_well_core_sample_anal, adapted code by vrajpoot  (task 1164)
...
as
   select /*+ use_nl(wcsa wv) */
     ...
     from well_core_sample_anal@c_talisman_ihsdata wcsa, ppdm.well_version wv
