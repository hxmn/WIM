...
drop view ppdm.ihs_well_test_pressure;
 
create or replace force view ppdm.ihs_well_test_pressure
(
  uwi,
  source,
  test_type,
...
as
  select /*+ use_nl(wtpr wv) */
         ...
         wtpr.row_quality,
         wtpr.province_state
    from well_test_pressure@c_talisman_ihsdata wtpr, well_version wv
...
grant select on ppdm.ihs_well_test_pressure to ppdm_ro;
