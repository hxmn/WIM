...
drop view ppdm.ihs_well_test_slope;

create or replace force view ppdm.ihs_well_test_slope
(
  uwi,
  source,
  test_type,
...
grant select on ppdm.ihs_well_test_slope to ppdm_ro;
