/***************************************************************************************************
 ihs_cdn_well_test_recorder  (view)

 20150817 copied from ihs_well_test_recorder, adapted code by vrajpoot  (task 1164)

 **************************************************************************************************/

--drop view ppdm.ihs_cdn_well_test_recorder;


create or replace force view ppdm.ihs_cdn_well_test_recorder
(
  uwi,
  source,
  test_type,
...
as
  select /*+ use_nl(wtrec wv) */
    ...
    from well_test_recorder@c_talisman_ihsdata wtrec, ppdm.well_version wv
...
grant select on ppdm.ihs_cdn_well_test_recorder to ppdm_ro;
