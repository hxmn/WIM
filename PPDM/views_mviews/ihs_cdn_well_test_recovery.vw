/***************************************************************************************************
 ihs_cdn_well_test_recovery  (view)

 20150817 copied from ihs_well_test_recovery, adapted code by vrajpoot  (task 1164)

 **************************************************************************************************/

--drop view ppdm.ihs_cdn_well_test_recovery;


create or replace force view ppdm.ihs_cdn_well_test_recovery
(
  uwi,
  source,
  test_type,
...
as
  select /*+ use_nl(wtrv wv) */ 
         ...
         wtrv.row_quality,
         wtrv.province_state
    from well_test_recovery@c_talisman_ihsdata wtrv, ppdm.well_version wv
...
grant select on ppdm.ihs_cdn_well_test_recovery to ppdm_ro;
