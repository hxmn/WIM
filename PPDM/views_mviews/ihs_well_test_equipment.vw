...
drop view ppdm.ihs_well_test_equipment;

create or replace force view ppdm.ihs_well_test_equipment
(
  uwi,
  source,
  test_type,
...
grant select on ppdm.ihs_well_test_equipment to ppdm_ro;
