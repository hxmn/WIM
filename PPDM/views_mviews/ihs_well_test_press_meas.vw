...
drop view ppdm.ihs_well_test_press_meas;

create or replace force view ppdm.ihs_well_test_press_meas
(
  uwi,
  source,
  test_type,
...
grant select on ppdm.ihs_well_test_press_meas to ppdm_ro;
