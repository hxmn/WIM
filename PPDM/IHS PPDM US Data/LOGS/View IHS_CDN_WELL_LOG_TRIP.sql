DROP VIEW PPDM.IHS_CDN_WELL_LOG_TRIP;

/* Formatted on 11/14/2012 7:11:00 AM (QP5 v5.185.11230.41888) */
CREATE OR REPLACE FORCE VIEW PPDM.IHS_CDN_WELL_LOG_TRIP
(
  UWI,
   SOURCE,
   JOB_ID,
...
AS
   SELECT /*+ RULE */
           ...
           wlt.TOP_STRAT_AGE,
           wlt.BASE_STRAT_AGE 
      FROM well_log_trip@c_talisman_ihsdata wlt, well_version wv
    WHERE     wv.ipl_uwi_local = wlt.uwi
          AND wv.SOURCE = '300IPL'
          AND wv.active_ind = 'Y';


GRANT SELECT ON PPDM.IHS_CDN_WELL_LOG_TRIP TO PPDM_RO;
